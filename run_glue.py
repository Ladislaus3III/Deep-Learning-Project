...
MODEL_NAME_TO_CLASS = {
    "roberta_modified": RobertaForSequenceClassificationCustom,
    "gpt2_modified": GPT2ForSequenceClassificationCustom
}
...
def main():
    ...
    if custom_model is not None:
        ...
        if custom_model == 'gpt2_modified':
            logger.info(f'Using hidden states in model: {True}')
        else:
